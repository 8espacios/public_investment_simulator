...
my_html = f"<script>var updateIframeHeight = 'false';var keepOverflowHidden = 'false';</script><script src='https://8espacios.mx/wp-content/plugins/advanced-iframe/js/ai_external.js'></script>"
